...
local success, AllowedHWIDs = pcall(function()
    return loadstring(game:HttpGet("https://raw.githubusercontent.com/nomamonx/gunung/refs/heads/main/hwid.lua"))()
end)
...
local teleportPoints = {
    CP1  = CFrame.new(-135, 422, -209),
    CP2  = CFrame.new(-12, 950, -1049),
    CP3  = CFrame.new(117, 1202, -1362),
    CP4  = CFrame.new(108, 1466, -1804),
    CP5  = CFrame.new(292, 1864, -2324),
    CP6  = CFrame.new(557, 2086, -2551),
    CP7  = CFrame.new(747, 2186, -2506),
    CP8  = CFrame.new(794, 2330, -2633),
    CP9  = CFrame.new(966, 2518, -2622),
    CP10 = CFrame.new(1619, 3058, -2760),
    CP11 = CFrame.new(2801, 4424, -4799),
    CP12 = CFrame.new(3471, 4858, -4186),
    CP13 = CFrame.new(3482, 5106, -4286),
    CP14 = CFrame.new(3981, 5666, -3977),
    CP15 = CFrame.new(4492, 5898, -3792),
    CP16 = CFrame.new(5065, 6370, -2983),
    CP17 = CFrame.new(5532, 6590, -2484),
    CP18 = CFrame.new(5548, 6874, -1041),
    CP19 = CFrame.new(4330, 7640, 126),
    CP20 = CFrame.new(3462, 7710, 942),
    Puncak = CFrame.new(3053, 7878, 1038), 
}
...
for i = 1, 21 do
    TeleTab:CreateButton({
        Name = "📍 Teleport CP " .. i,
        Callback = function()
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = teleportPoints["CP"..i]
        end
    })
end

TeleTab:CreateButton({
    Name = "⛰️ Teleport Puncak",
    Callback = function()
...
local autoTeleportPoints = {
    teleportPoints.CP1, teleportPoints.CP2, teleportPoints.CP3,
    teleportPoints.CP4, teleportPoints.CP5, teleportPoints.CP6,
    teleportPoints.CP7, teleportPoints.CP8, teleportPoints.CP9,
    teleportPoints.CP10, teleportPoints.CP11, teleportPoints.CP12,
    teleportPoints.CP13, teleportPoints.CP14, teleportPoints.CP15,
    teleportPoints.CP16, teleportPoints.CP17, teleportPoints.CP18,
    teleportPoints.CP19, teleportPoints.CP20,teleportPoints.Puncak
}
