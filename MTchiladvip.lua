...
InfoTab:CreateSection("Info Tambahan")
InfoTab:CreateParagraph({
    Title = "PENTING!!!",
    Content = "Jika Mau Troll Jalani emote lain dulu dan jalankan Ikuti Player😁. Dan Fitur Check Pro ( Hanya Terbaca DI Server Jika Hasil Puncaknya Ada Di Papan Peringkat!!! ",
})
